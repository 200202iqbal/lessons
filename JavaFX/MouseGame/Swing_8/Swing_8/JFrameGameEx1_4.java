...
// BGMを追加する
public class JFrameGameEx1_4 extends JFrame {
	JFrameGameEx1_4() {
		setSize(800, 600);
		setTitle("モグラたたき_4");
	...
	public static void main(String[] args) {
		JFrame frame = new JFrameGameEx1_4();
	...
	class GamePanel extends JPanel {
		...
		public GamePanel() {
			...
			moguthread.start();
			//	BGMを設定する
			midiMoguraDance = new KSoundMidi(this, "../mouseGame/sound/MoguraDance.mid", false);
			// 効果音を設定する
			waveMoguraDeru = new KSoundWave(this, "../mouseGame/sound/MoguraDeru.wav", false);
			wavePikoHammerMiss = new KSoundWave(this, "../mouseGame/sound/PicoHammerMiss.wav", false);
			wavePikoHammerHit = new KSoundWave(this, "../mouseGame/sound/PicoHammerHit.wav", false);
